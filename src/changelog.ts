...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    date: '2026-06-29',
    changes: [
      { type:'feat',  scope:'history', fr:'Les événements de l\'historique précisent maintenant l\'élément concerné (ex. « Déplacement : Publicité Facebook ») ou un compte pour les actions multiples (ex. « Suppression · 3 éléments »)', en:'History events now name the affected element (e.g. "Moved: Facebook Ads") or show a count for multi-element actions (e.g. "Deleted · 3 items")' },
      { type:'style', scope:'history', fr:'Nouvelles flèches Annuler/Rétablir style Bee (flèches courbes gauche/droite) remplaçant l\'ancien design', en:'New Bee-style Undo/Redo arrows (left/right curved arrows) replacing the old design' },
      { type:'feat',  scope:'history', fr:'La frise se referme automatiquement après avoir cliqué une entrée', en:'The timeline closes automatically after clicking an entry' },
